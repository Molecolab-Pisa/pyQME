...
freq_axis,GSB_a,SE_a,ESA_a,PP_a = spectrum_obj.calc_pump_probe_exc(dipoles,pop_t_exc) #to be saved
_,GSB,SE,ESA,PP = spectrum_obj.calc_pump_probe(dipoles,pop_t_exc) #to be saved
