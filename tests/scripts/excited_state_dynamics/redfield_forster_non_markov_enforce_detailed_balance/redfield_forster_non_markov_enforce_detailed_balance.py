...
redf_deph = rel_tens_obj.calc_redf_xi()[:,-1]/rel_tens_obj.specden.time[-1]
rel_tens_obj = enforce_detailed_balance(rel_tens_obj,rel_tens_obj.ene-rel_tens_obj.get_lambda_a()+redf_deph.imag)
