...
_,OD_i = spectrum_obj.calc_OD_site(dipoles=dipoles)   #to be saved
_,OD_ij = spectrum_obj.calc_OD_sitemat(dipoles=dipoles)   #to be saved
_,OD_a = spectrum_obj.calc_OD_exc(dipoles=dipoles)   #to be saved
